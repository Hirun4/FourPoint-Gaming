...
const topGames = [
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/1245620/ELDEN_RING/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/2322010/God_of_War_Ragnarok/' 
  },
  {
    ...
    buyNowLink: 'https://store.playstation.com/en-us/product/UP9000-CUSA07820_00-THELASTOFUSPART2' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/1174180/Red_Dead_Redemption_2/'
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/292030/The_Witcher_3_Wild_Hunt/' 
  },
  {
    name: 'Cyberpunk 2077',
    ...
    buyNowLink: 'https://store.steampowered.com/app/1091500/Cyberpunk_2077/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/2420110/Horizon_Forbidden_West_Complete_Edition/' 
  },
  {
    ...
    buyNowLink: 'https://www.playstation.com/en-us/games/ghost-of-tsushima/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/1196590/Resident_Evil_Village/' 
  },
  {
    ...
    buyNowLink: 'https://www.playstation.com/en-us/games/marvels-spider-man-miles-morales/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/1462040/FINAL_FANTASY_VII_REMAKE_INTERGRADE/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/2208920/Assassins_Creed_Valhalla/'
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/1850570/DEATH_STRANDING_DIRECTORS_CUT/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/814380/Sekiro_Shadows_Die_Twice__GOTY_Edition/' 
  },
  {
    name: 'Doom Eternal',
    ...
    buyNowLink: 'https://store.steampowered.com/app/782330/DOOM_Eternal/' 
  },
  {
    ...
    buyNowLink: 'https://store.steampowered.com/app/582010/Monster_Hunter_World/' 
  },
  {
    name: 'Dark Souls III',
    ...
    buyNowLink: 'https://store.steampowered.com/app/374320/DARK_SOULS_III/' 
  },
  {
    name: 'Control',
    ...
    buyNowLink: 'https://store.steampowered.com/app/870780/Control_Ultimate_Edition/' 
  },
  {
    name: 'Borderlands 3',
    ...
    buyNowLink: 'https://store.steampowered.com/app/397540/Borderlands_3/' 
  },
  {
    name: 'Overwatch',
    ...
    buyNowLink: 'https://store.steampowered.com/app/2357570/Overwatch_2/' 
  },
];
    ...
    <div className="bg-gray-800 text-white py-12 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {topGames.map((game, index) => (
          <div
            key={index}
            className="bg-gray-900 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl"
          >
            ...
            <a
              href={game.buyNowLink}
              className="inline-block px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg transition-colors hover:bg-blue-600"
              target="_blank"
