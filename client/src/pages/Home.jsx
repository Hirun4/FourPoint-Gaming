...
export default function Home() {
  ...
  return (
    <div>
      <div className='flex flex-col gap-6 p-28 px-3  mx-auto bg-pink-150 dark:bg-slate-700'>
      ...
      <div className='p-3 bg-lime-200 dark:bg-slate-700'>
        <CallToAction />
      </div>

      <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 py-7 bg-red-100 dark:bg-slate-700'>
        {posts && posts.length > 0 && (
          <div className='flex flex-col gap-6'>
            <h2 className='text-2xl font-semibold text-center animate-glow'>Recent Posts</h2>
